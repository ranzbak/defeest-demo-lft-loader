...
begin:
  ...
  // Switch SID bank to $4000-$bfff (for now)
  lda #$3D
  sta REG_VICBANK         // SPINDLE: For Spindle change to $DD02
...
bitmap_top_fld_done:
  ldx #018                        // wait for raster to get into position for bitmap
!loop:
  dex
  bne !loop-
...
reset_hardware_scroll:
  ...
  ldy #251                   // wait for final scanline done
wait_scroller_end:
  cpy REG_RASTERLINE
